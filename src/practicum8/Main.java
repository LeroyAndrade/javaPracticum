...
public class Main {
    public static void main(String[] args) {
        ...
        Computer computer1 = new Computer("Mac", "B7-C3-7B-B2-FE-7E", 1059, 2025);
        Computer computer2 = new Computer("Windows", "B7-C3-7B-B2-FE-7D", 858, 2025);
        System.out.println(computer1+"\n");
        System.out.println(computer2+"\n");

        Fiets fiets1 = new Fiets("Batavus", 1159.99, 2021, 1230100);
        Fiets fiets2 = new Fiets("Batavus", 1009.99, 2022, 280600);
